...
class Corregistro3D(QWidget):
    ...
    def init_ui(self):
        ...
        self.bright1_slider.setRange(1, 20)
        ...
        self.contrast1_slider.setRange(1, 20)
        ...
        self.bright2_slider.setRange(1, 20)
        ...
        self.contrast2_slider.setRange(1, 20)
    ...
    def load_image_transformar(self):
        ...
        # ¡NUEVO! al cargar la segunda imagen, centramos también los sliders
        self.update_sliders()
        self.reset_cache()
        self.update_views()
